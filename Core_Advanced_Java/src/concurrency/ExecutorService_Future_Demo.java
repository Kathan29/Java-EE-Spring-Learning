...
public class ExecutorService_Future_Demo {
	...
	public static void main(String[] args) {
		ExecutorService_Future_Demo demo = new ExecutorService_Future_Demo();
		demo.add(new ExecutorService_Future_Demo.Weblink(2000, "Nested Classes",
				"https://docs.oracle.com/javase/tutorial/java/javaOO/nested.html", "httpz://docs.oracle.com"));
		demo.add(new ExecutorService_Future_Demo.Weblink(2001, "Java SE Downloads",
				"https://www.oracle.com/technetwork/java/javase/downloads/index.html", "http://www.oracle.com"));
		demo.add(new ExecutorService_Future_Demo.Weblink(2002, "Interface vs Abstract Class",
				"https://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		demo.add(new ExecutorService_Future_Demo.Weblink(2004, "Virtual Hosting and Tomcat",
